...
public class HotMessageFragment extends Fragment{
        ...
        public void handleMessage(Message msg){
            switch (msg.what){
                case SHOW_NEW_RESPONSE:
                    ...
                    hAdapter = new HotMessageAdapter(getActivity(),
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        hotmsgView = (ListView) view.findViewById(R.id.show_hotmessage);
        materialRefreshLayout = (MaterialRefreshLayout) view.findViewById(R.id.swipe_to_refresh);
